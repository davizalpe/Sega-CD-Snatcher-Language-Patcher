...
<div class="reviews index">
	...
	<tr>		
		...
		<td class="actions">
			<?php
			// If is not validated yet or not has other review validated
			// can validate the review
			if( !$review['Review']['validated'] &&
					!$review['Review']['hasValidatedReview'])
			{
				...
				echo $this->Form->postLink(
					...
					array_merge(
						$this->passedArgs,
						array('action' => 'validation', $review['Review']['id'])					
					), 
					null,
					__('Validate Review?'));
			}
